...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    ctaEn: 'Upgrade Now',
    popular: true,
    stripePriceId: 'price_1KtXUTJvCCwFA8fB', // 需要替換為實際的 Stripe Price ID
  },
  {
    id: 'lifetime',
    name: '尊享版',
    ...
    cta: '一勞永逸',
    ctaEn: 'Get Lifetime',
    stripePriceId: 'price_1KtXUTJvCCwFA8fC', // 需要替換為實際的 Stripe Price ID
  },
];
...
export const STRIPE_PRODUCTS = {
  ...
  lifetime: {
    ...
    unitAmount: 0, // Free (special offer)
    currency: 'usd',
    // 一次性付款，無 recurring
  },
};
