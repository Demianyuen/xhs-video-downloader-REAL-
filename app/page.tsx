  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-orange-50 to-yellow-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12 animate-fade-in-delay-1">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex gap-4 animate-slide-in-left">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-gradient-to-r from-pink-500 to-orange-500 text-white font-bold hover-scale">
                  1
                </div>
              </div>
              <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-xl shadow p-6 border-l-4 border-pink-500 hover:shadow-lg transition animate-fade-in-delay-1 hover-lift">
          ...
          <div className="bg-white rounded-xl shadow p-6 border-l-4 border-orange-500 hover:shadow-lg transition animate-fade-in-delay-2 hover-lift">
            <div className="text-3xl mb-3">⚡</div>
          ...
          <div className="bg-white rounded-xl shadow p-6 border-l-4 border-yellow-500 hover:shadow-lg transition animate-fade-in-delay-3 hover-lift">
            <div className="text-3xl mb-3">🔒</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['MP4', '1080p', '720p', '480p', '360p'].map((format, idx) => (
                  <span key={format} className="bg-white px-3 py-1 rounded-full text-sm font-medium text-gray-700 border border-pink-200 hover-scale transition-smooth" style={{animationDelay: `${idx * 0.1}s`}}>
                    {format}
                  </span>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Transcripts', 'Subtitles', 'Metadata', 'Batch Download'].map((feature, idx) => (
                  <span key={feature} className="bg-white px-3 py-1 rounded-full text-sm font-medium text-gray-700 border border-orange-200 hover-scale transition-smooth" style={{animationDelay: `${idx * 0.1}s`}}>
                    {feature}
                  </span>
                ))}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12 animate-fade-in-delay-2">
          ...
          <div className="space-y-4">
            <details className="group border border-gray-200 rounded-lg p-4 hover:border-pink-300 transition hover-lift">
        ...
        <div className="bg-gradient-to-r from-pink-500 to-orange-500 rounded-2xl shadow-lg p-8 text-white text-center animate-scale-in">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="hover-scale transition-smooth">
              <div className="text-4xl mb-2 animate-bounce" style={{animationDelay: '0.3s'}}>♾️</div>
